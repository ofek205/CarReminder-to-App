    ...
    <div dir="rtl" className="max-w-2xl mx-auto py-6 px-4">
      ...
      <div className="space-y-5 text-sm leading-relaxed" style={{ color: C.gray700 }}>
        ...
        {/*
          ...
          Wording approved by Ofek on 2026-09-26, including the 7.7 correction
          he approved the same day (usage caps such as the AI expert and plate
          checks also fall back to free, not only adding). Legal text: reword
          only with his approval, not as a copy edit.
        */}
        <section>
          ...
          <div className="space-y-2">
            ...
            <p><strong>7.7 סיום המנוי.</strong> כשמנוי מסתיים, מכל סיבה שהיא, החשבון עובר למסלול החינמי. שום מידע לא נמחק והתזכורות ממשיכות: כלי התחבורה והמסמכים שכבר בחשבון נשארים בו. מאותו רגע חלות מגבלות המסלול החינמי: לא תתאפשר הוספה מעבר להן, והשימוש בשירותים שיש להם מכסה, כמו מומחה ה-AI ובדיקת רכב, יהיה לפי המכסה של המסלול החינמי.</p>
