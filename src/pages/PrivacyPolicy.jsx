      ...
      <div className="space-y-5 text-sm leading-relaxed" style={{ color: C.gray700 }}>
        ...
        <section>
          ...
          <ul className="list-disc mr-5 space-y-1">
            ...
            <li>מענה בצ'אט היועץ החכם על השאלות שאתה שולח</li>
            <li>קריאת מסמכים ולוחיות רישוי שאתה מצלם, כדי למלא שדות אוטומטית</li>
        ...
        <section>
          ...
          <h3 className="text-sm font-bold mt-4 mb-1">שיתוף עם שירותי AI</h3>
          <p>
            כדי לספק את צ'אט היועץ, את תגובות ה-AI בקהילה ואת קריאת המסמכים,
            אנו שולחים את התוכן הרלוונטי לספקי AI חיצוניים:
            <strong> Google (Gemini)</strong>, ובהתאם לזמינות גם
            <strong> Groq</strong> ו-<strong>Anthropic (Claude)</strong>.
          </p>
          <p className="mt-2">מה נשלח בפועל:</p>
          <ul className="list-disc mr-5 mt-1 space-y-1">
            <li>בצ'אט היועץ: <strong>הטקסט שאתה כותב</strong>, כולל פרטים שתבחר לכתוב בו</li>
            <li>בקהילה: הפוסט או התגובה שפורסמו</li>
            <li>בסריקת מסמך או לוחית: <strong>התמונה שצילמת</strong>. מסמכים כמו רישיון נהיגה, רישיון רכב או ביטוח מכילים פרטים מזהים</li>
          </ul>
          <p className="mt-2">
            התוכן נשלח <strong>בלי מזהי החשבון שלך</strong> (בלי המייל, השם או
            רשימת הרכבים). הספקים אינם מקבלים גישה למסד הנתונים שלנו ואינם
            מזהים אותך לפי החשבון. עם זאת, אם תכתוב פרטים מזהים בגוף השאלה או
            תצלם מסמך, הם ייכללו בתוכן שנשלח.
          </p>
        </section>
