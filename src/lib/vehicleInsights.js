...
function inactiveInsight(vehicle) {
  ...
  return insight(
    ...
    vehicle._cancellationDate
      ? `תאריך ביטול במקור המידע: ${vehicle._cancellationDate}. יש לברר את מצב הרישוי והאפשרות להחזרה לכשירות מול משרד התחבורה לפני רכישה או שימוש. תוצאת הבדיקה אינה אישור לנסיעה.`
