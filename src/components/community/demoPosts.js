...
export const DEMO_POSTS_VEHICLE = [
  ...
  },
  {
    ...
    domain: 'vehicle',
    body: 'עשיתי טסט אתמול ונפלתי על פליטת גזים. הרכב מאזדה 3 2016. המוסכניק אומר שצריך להחליף קטליזטור בעלות 3,500 ₪. זה נשמע סביר?',
    image_url: null,
    linked_vehicle_id: null,
...
export const DEMO_COMMENTS = {
  ...
  'demo_vp_2': [
    { id: 'demo_vc_3', post_id: 'demo_vp_2', user_id: 'demo_ai', author_name: '🔧 ברוך המוסכניק', body: 'אם ממלאים גז מזגן 3 פעמים בשנה, סימן שיש נזילה. צריך לעשות בדיקת לחץ עם צבע UV כדי לאתר את מקום הנזילה. ברוב המקרים זה O-ring או צנרת שנשחקה. תיקון הנזילה עצמה עולה 300-600 ₪ + מילוי גז 250 ₪.', is_ai: true, created_at: new Date(Date.now() - 4.5 * 60 * 60 * 1000).toISOString() },
  ],
  'demo_vp_3': [
