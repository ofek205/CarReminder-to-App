...
export default function MarketingPhone({ src, alt, priority = false, trimGuest = true }) {
  return <div className="cm-phone">
    ...
    <div className="cm-phone-display">
      ...
      <div className={`cm-phone-content${trimGuest ? ' cm-trim-guest' : ''}`}>
