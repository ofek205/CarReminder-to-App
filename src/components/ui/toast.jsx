...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
      "absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-2xl bg-gray-100 text-gray-600 transition-colors hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-ring group-[.destructive]:bg-red-100 group-[.destructive]:text-red-600 group-[.destructive]:hover:bg-red-200",
      className
    )}
    toast-close=""
    {...props}
