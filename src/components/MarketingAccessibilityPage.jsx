...
const LIMITATIONS = [
  'בתוך איורי המכשירים באתר מוצגות הדמיות של מסכי האפליקציה. הטקסט בתוך ההדמיות קטן (6 עד 9 פיקסלים) ואינו עומד בניגודיות הנדרשת. מדובר באיור ולא בתוכן: כל מידע שמופיע בו מופיע גם בטקסט שלצדו. תיקון מתוכנן.',
  'מסמכי PDF שניתן להפיק מהאתר, ובכללם דוח בדיקת הרכב, טרם נבדקו מול חלק 2 של תקן 5568 העוסק בנגישות מסמכים דיגיטליים.',
