  ...
  return (
    ...
    >
      <div className="absolute inset-y-0 left-0 w-[38px] bg-[#0A3A78] border-r border-[#072A56] flex flex-col items-center justify-center">
        <span className="text-white text-[9px] leading-none font-bold">IL</span>
      ...
      <input
        ...
        className={`w-full bg-transparent text-center font-bold tabular-nums text-black placeholder:text-black/30 outline-none disabled:opacity-60 ${
