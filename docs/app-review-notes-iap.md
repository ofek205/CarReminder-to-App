...
| 3 | כפתור שחזור רכישות גלוי במסך המסלולים | אפל פוסלת בדרך כלל מנוי בלי כפתור כזה. היום השחזור קורה רק אוטומטית, ⚠️ והכפתור עוד לא קיים |
...
⚠️ **החלק על שחזור רכישות נכון רק אחרי שהכפתור ייבנה.** אם מגישים בלי הכפתור, מוחקים את השורה הראשונה שבחלק הזה. אבל זה הסיכון הגדול ביותר לפסילה.
